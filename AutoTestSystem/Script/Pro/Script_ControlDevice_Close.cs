...
{
    internal class Script_ControlDevice_Close :Script_ControlDevice_Base
    {
        ...
        {
            if (ControlDevice.UnInit())
            {
                LogMessage("Uninit sucess !!", MessageLevel.Info);
                return true;
            }
            LogMessage("Uninit fail !!", MessageLevel.Info);
            return false;
        }
