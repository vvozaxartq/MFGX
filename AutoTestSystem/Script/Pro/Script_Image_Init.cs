...
{
    internal class Script_Image_Init : Script_Image_Base
    {
        ...
        [Category("Parameter"), Description("Define the Input Sting on your Image Device")]
        ...
        {
            if (Image.Init(ReplaceProp(Input_Data)))
            {
