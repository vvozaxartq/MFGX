...
namespace AutoTestSystem.Script
{
    ...
    internal class Script_Extra_SingleEntry : Script_Extra_Base
    {
        ...
        byte[] input;
        [Category("Params"), Description("SE PIN Content.")]
        ...
        [Category("Params"), Description("SE PIN Content."), Editor(typeof(CommandEditor), typeof(UITypeEditor))]
        ...
        public override bool Process(ref string strOutData)
        {
            ...
            try
            {
                ...
                //{
                    ...
                    LogMessage($"add:\n{str_Address}");
                    PIN = PIN.Replace("%buf_addr%", str_Address);

                    string SE_Pout = string.Empty;
                    IQ_SingleEntry.SE_IVS(PIN, ref SE_Pout);
                ...
                IQ_SingleEntry.SaveImage(input, width, height, $"output_after_clear.bmp");
                //}
                //finally
                //{
                //    handle.Free(); // 釋放 GCHandle
                //}
            }
            catch (Exception ex)
            {
            ...
            //finally
            //{
            //    Array.Clear(input, 0, input.Length); // 清理 byte[] input
            //}
